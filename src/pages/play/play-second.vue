<template>
	<view class="page-container">
		...
		<view class="debug-controls" v-if="showDebug && !isSuccess" @touchmove.stop.prevent>
		...
		<!-- 可拖动的手机图片 -->
		<view class="draggable-phone" :style="phoneStyle" @touchstart="onTouchStart" @touchmove.stop.prevent="onTouchMove"
			@touchend="onTouchEnd">
...
@keyframes pulse-border {
	...
	50% {
		...
		box-shadow: 0 0 35px rgba(255, 255, 255, 0.45), inset 0 0 35px rgba(255, 255, 255, 0.2);
	}
}
...
.thumb {
	...
	animation: thumbScale .45s ease-out forwards;
	z-index: 20;
}
